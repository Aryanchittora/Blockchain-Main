...
class Block(object):
    def __init__(self):
        ...
        self.count = 0
        self.new_block(previous_hash="No previous Hash. Since this is the first block.", proof=265)  # Task 01 - Change the value of Proof
...
print('\nPrevious block proof:',previous_proof)

proof = blockchain.proof_of_work(previous_proof)
print("\nFound proof of work at:",proof)
...
print("\nData of blockchain:",blockchain.chain)
