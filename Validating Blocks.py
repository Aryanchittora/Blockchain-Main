...
blockData = blocksData = blockchain.chain
NumberOfBlocks = len(blockData)
print(f'Number of blocks = {NumberOfBlocks}')

# Write Task 02 code from below
print('Previous hash of Genesis Block -', blockData[0]["previous_hash"])
print('Current hash of Genesis Block -', blockchain.chain[0]["Current_hash"])
print('Current hash of Block 1 -', blockData[2]["previous_hash"])

# Write Task 03 code from below
if blockData[0]['Current_hash'] == blockData[2]["previous_hash"]:
