...
Label(frame, text='Account 1 - ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=0, column=0, pady=8, sticky=W)
Label(frame, text='Account 2 - ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=1, column=0, pady=8, sticky=W)
Label(frame, text='Private Key - ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=2, column=0, pady=8, sticky=W)
Label(frame, text='Ether Ammount - ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=3, column=0, pady=8, sticky=W)
Label(frame, text='Gas Limit (GWEI) - ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=4, column=0, pady=8, sticky=W)
Label(frame, text='Gas Price - (GWEI) ', fg='white', bg='#000000', font=('Bold', '12')).grid(row=5, column=0, pady=8, sticky=W)
