...
# add the code for chain_valid() function
    def chain_valid(self, chain):
        ...
        while block_index < len(chain):
            ...
            print('Current Nonce -', current_nonce)
            compare = current_nonce ** 2 - previous_nonce ** 2
            print('Comaparison of Proof -',compare)
            str_compare = str(compare).encode()
            print('Proof(str) -', str_compare)
            encode_proof = hashlib.sha256(str_compare)
            print('Proof(encode) -', encode_proof)
            hash_proof = encode_proof.hexdigest()
            print('Current Nonce is -', hash_proof)
